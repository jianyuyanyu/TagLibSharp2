...
{
	/// <summary>
	/// Gets the parsed format chunk, or null if parsing failed.
	/// </summary>
	...
	/// </summary>
	/// <param name="chunk">The parsed format chunk.</param>
	...
	/// </summary>
	public static bool operator == (DsfFmtChunkParseResult left, DsfFmtChunkParseResult right) =>
		left.Equals (right);
